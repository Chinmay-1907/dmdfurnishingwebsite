...
- **NOTE:** WebFetch reported no meta tags visible — likely due to client-side rendering obscuring them in the initial HTML. The metadata IS declared in the page component.
