      ...
      <article className={styles.container}>
        <header className={styles.articleHeader}>
          <p className={styles.articleMeta}>
            Published <time dateTime="2026-03-12">March 12, 2026</time>
            {' · '}
            Updated <time dateTime="2026-03-26">March 26, 2026</time>
            {' · '}
        ...
        <div className={styles.content}>
          ...
          <p>
            ...
            re-approving submittals. To see where that window falls in a typical project
            schedule, review our{' '}
            <Link href="/blog/ffe-procurement-timeline">FF&amp;E procurement timeline</Link>.
            And for the manufacturing standards and processes behind every specification
            decision, our{' '}
          ...
          <p>
            ...
            notice in day-to-day use. Our{' '}
            <Link href="/blog/hpl-veneer-solid-wood-hotel-casegoods">
              HPL vs veneer vs solid wood comparison
            </Link>{' '}
