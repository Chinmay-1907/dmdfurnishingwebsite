...
export const placeContent = {
  ...
  residential: {
    intro:
      "DMD Furnishing manufactures multi-family and residential furniture for apartment developers, property management companies, student housing operators, and senior living communities. Clubhouse sofas, leasing office desks, rooftop seating, package-room casegoods, and indoor walk-in closet systems are built to contract-grade commercial durability, not residential-grade, because amenity spaces and model units see hospitality-level traffic. Multi-family residential furniture is a commercial category, not a consumer one. Apartment clubhouses, leasing offices, amenity lounges, rooftop common areas, and unit interiors are used by hundreds of residents every week. Our multi-family and residential furniture scope spans leasing offices, clubhouse lounge and dining, fitness lobbies, outdoor pool decks, and custom walk-in closet systems for primary suites and model units.",
    buyingGuide: [
      {
      ...
      {
        title: "Size walk-in closet systems to the actual unit, not a catalog default",
        text: "Walk-in closet systems range from a compact single-loaded run for a condo-width closet to an L-shaped or double-sided layout for a larger primary suite. Confirm door swing, walkway clearance, and ceiling height before finalizing the layout so the modular panels and drawer banks fit the room on the first install, not a rework.",
      },
    ],
    materials:
    ...
    faqs: [
      ...
      {
        question: "How much space does an indoor walk-in closet need?",
        answer:
          "It depends on the layout. A single-loaded compact system can work in a closet as narrow as four to five feet wide, while an L-shaped or floor-to-ceiling double-sided system needs a room deep enough for a walkway plus storage on one or both walls. We size the modular panels, hanging rods, and drawer banks to the room dimensions you provide rather than fitting the room to a fixed catalog size.",
      },
      {
        question: "Can a walk-in closet be installed in a condo or a smaller unit?",
        answer:
          "Yes. We build reduced-depth, single-loaded walk-in closet systems specifically for condo and urban multi-family footprints, sized to clear standard door swings and walkway minimums without dropping to wire-shelving quality. Larger units can take an L-shaped, double-sided, or dressing-room-with-vanity layout instead.",
      },
      {
        question: "What are walk-in closet systems built from?",
        answer:
          "Panel components are HPL laminate faced, edge-banded, and moisture-sealed on an engineered-wood carcass, with powder-coated steel supports on floor-to-ceiling and double-sided runs. Drawers use full-extension, soft-close commercial slides and hanging rods sit on reinforced brackets, the same contract-grade construction standard we use across the rest of the residential and multi-family catalog.",
      },
    ],
  },
  "lobby-area": {
...
/**
 * Contextual "related guides" links per vertical so product hubs link back up
 * to the pillar/spoke content (two-way topic cluster, not a one-way link sink).
 */
export const placeRelatedGuides = {
  hotel: [
    { href: '/guides/hospitality-ffe', title: 'Hospitality FF&E Guide', blurb: 'Budgeting, procurement, and specification for hotel projects.' },
    { href: '/blog/hotel-guestroom-furniture-checklist', title: 'Hotel Guestroom Furniture Checklist', blurb: 'Every piece a guestroom needs, with spec guidance.' },
    { href: '/blog/hpl-veneer-solid-wood-hotel-casegoods', title: 'HPL vs Veneer vs Solid Wood', blurb: 'Choosing the right surface for hotel casegoods.' },
  ],
  restaurant: [
    { href: '/blog/restaurant-seating-guide', title: 'Restaurant Seating Guide', blurb: 'Booth, chair, or bar stool — and how to mix them.' },
    { href: '/guides/hospitality-ffe', title: 'Hospitality FF&E Guide', blurb: 'How F&B furniture fits the wider FF&E budget.' },
    { href: '/blog/ffe-procurement-timeline', title: 'FF&E Procurement Timeline', blurb: 'Concept to install, and where seating fits.' },
  ],
  office: [
    { href: '/blog/office-furniture-commercial-projects', title: 'Office Furniture Procurement Guide', blurb: 'Standards, zoning, and lead-time sequencing for office fit-outs.' },
    { href: '/guides/commercial-furniture-manufacturing', title: 'Commercial Furniture Manufacturing Guide', blurb: 'Standards, materials, and process behind contract-grade builds.' },
    { href: '/blog/value-engineering-commercial-furniture', title: 'Value Engineering Commercial Furniture', blurb: 'Cutting cost without losing design intent.' },
  ],
  hospital: [
    { href: '/blog/healthcare-furniture-guide', title: 'Healthcare Furniture Guide', blurb: 'Durability, cleanability, and compliance for clinical spaces.' },
    { href: '/guides/commercial-furniture-manufacturing', title: 'Commercial Furniture Manufacturing Guide', blurb: 'Construction standards behind healthcare-grade furniture.' },
    { href: '/blog/value-engineering-commercial-furniture', title: 'Value Engineering Commercial Furniture', blurb: 'Stretching capital budgets on clinical fit-outs.' },
  ],
  'educational-facilities': [
    { href: '/blog/student-housing-furniture-guide', title: 'Student Housing Furniture Guide', blurb: 'Specifying beds, desks, and casegoods that survive turnover.' },
    { href: '/guides/commercial-furniture-manufacturing', title: 'Commercial Furniture Manufacturing Guide', blurb: 'How contract-grade classroom furniture is built.' },
    { href: '/blog/ffe-procurement-timeline', title: 'FF&E Procurement Timeline', blurb: 'Planning around academic-calendar install windows.' },
  ],
  residential: [
    { href: '/blog/multifamily-ffe-guide', title: 'Multifamily FF&E Guide', blurb: 'Model units, furnished units, and amenity spaces, each specced right.' },
    { href: '/guides/commercial-furniture-manufacturing', title: 'Commercial Furniture Manufacturing Guide', blurb: 'Contract-grade construction for amenity and common spaces.' },
    { href: '/blog/ffe-procurement-timeline', title: 'FF&E Procurement Timeline', blurb: 'Sequencing furniture for lease-up deadlines.' },
  ],
  'lobby-area': [
    { href: '/blog/hotel-lobby-furniture-guide', title: 'Hotel Lobby Furniture Guide', blurb: 'Zoning public spaces and picking pieces that survive 24/7 use.' },
    { href: '/guides/hospitality-ffe', title: 'Hospitality FF&E Guide', blurb: 'Public-area furniture inside the FF&E package.' },
    { href: '/blog/what-is-ffe-hospitality', title: 'What Is FF&E? Meaning, Examples, and FF&E vs OS&E', blurb: 'The definition, examples by category, and FF&E vs OS&E.' },
  ],
};
