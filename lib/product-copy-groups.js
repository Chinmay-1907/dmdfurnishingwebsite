...
export const SUBCATEGORY_COPY_GROUPS = {
  ...
  "Toy Storage": {
    ...
    specification: {
      ...
      body: 'A {name} is specified against the room dimensions and any existing storage bins or organization system, so DMD confirms cubbie count and compartment sizing before production. Send room dimensions and finish preference; we return a configuration sized to the space with anti-tip anchoring details for the installer. Finish can be matched to existing bedroom furniture on request, and unit count scales for classroom or shared-room orders across a full renovation project.',
    },
  },
  "Wardrobe": {
    materials: {
