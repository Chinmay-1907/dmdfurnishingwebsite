...
const INSPIRATIONS = [
  {
    ...
    description:
      'Clean-lined furniture in a warm neutral palette creates a welcoming lobby atmosphere built for daily guest traffic.',
    fullDescription:
      'This hotel lobby pairs a warm neutral material palette with clean-lined furniture built for high-traffic daily use. The reception desk is walnut veneer on a steel subframe. Seating areas use commercial-grade upholstery rated for constant guest turnover. Ambient lighting sits inside the millwork rather than bolted on as an afterthought.',
    image:
  ...
  },
  {
    ...
    description:
      'Jewel-tone velvet seating and rich oak framing elevate a fine dining room with sophisticated, long-lasting comfort.',
    fullDescription:
      'Custom dining seating that balances comfort and durability for fine dining service. Deep jewel-tone velvet upholstery pairs with solid oak frames and brass accent hardware. Ergonomic seat profiles keep guests comfortable through a multi-course meal. Every frame is built to commercial contract-grade standards so it holds up to nightly restaurant service.',
    image:
  ...
  },
  {
    ...
    description:
      'A perfect blend of luxury and comfort in a boutique hotel suite where every custom-designed piece is built to one coordinated spec book.',
    fullDescription:
      'A boutique suite where every furniture piece is custom-designed to a single spec book. The headboard integrates reading lights and USB charging at each side. The seating area uses the same veneer palette as the casegoods for visual continuity. Bed frame, nightstands, desk, and luggage bench are all manufactured as a matched set.',
    image:
  ...
  },
  {
    ...
    description:
      'Sophisticated and functional furniture creates an ideal environment for business travelers juggling focus, calls, and comfort.',
    fullDescription:
      'An executive lounge built for business travelers who need both focus and comfort. Private pods with acoustic panels for calls. Communal worktables with integrated power and cable management. Ergonomic task seating in premium leather. The material palette uses warm woods and commercial-grade fabrics that hold up to heavy daily lounge use.',
    image:
  ...
  },
  {
    ...
    description:
      'Light, airy furniture in natural materials perfectly complements a beachfront property where sun, salt, and moisture are daily variables.',
    fullDescription:
      'Resort furniture that takes its cues from the surrounding environment. Light, airy pieces in rattan and teak with performance fabrics rated for sun, salt, and moisture exposure. The color palette pulls from sand and ocean tones. Every piece is weather-resistant and UV-protected without sacrificing a high-end finish.',
    image:
  ...
  },
  {
    ...
    description:
      'Industrial-inspired furniture with warm accents creates a welcoming, high-traffic space for a busy city cafe.',
    fullDescription:
      'An urban cafe with mixed seating zones: communal tables for the social crowd, lounge corners for longer stays. Reclaimed wood tops on powder-coated steel frames strike a balance between industrial edge and warmth. The layout optimizes foot traffic while carving distinct zones for quick turnover and slower sessions.',
    image:
